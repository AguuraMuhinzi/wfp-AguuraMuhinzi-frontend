          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              {/* <button className="hidden md:flex bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg shadow-lg transition-colors duration-200 items-center">
                ...
                <Link
                      to="/login"
                      className="hidden md:flex bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg shadow-lg transition-colors duration-200 items-center">
                      Get Started
                      <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
              ...
              <div className="flex flex-col space-y-4 pt-4">
                ...
                {/* <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg w-full transition-colors duration-200">
                  Get Started
                    ...
                    <Link
                      to="/login"
                      className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg w-full transition-colors duration-200 text-center"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      Get Started
                    </Link>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            {[
              { name: "Naome Joyeuse", role: "Developer", image: "imgs/naome.jpg" },
              { name: "Kanyana Daniella", role: "Developer", image: "imgs/daniella.jpg" },
              { name: "Fadmata Diallo", role: "Developer", image: "imgs/fadmata.jpg" },
              { name: "Ganza Kevin", role: "Developer", image: "imgs/kevin.jpg" },
              { name: "Ganza Tomobola", role: "Developer", image: "imgs/tombola.jpg" },
            ].map((member, index) => (
