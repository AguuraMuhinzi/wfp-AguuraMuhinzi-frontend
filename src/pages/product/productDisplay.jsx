...
//       <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
...
//                   "We are a dedicated farming cooperative committed to sustainable agriculture and providing the freshest, highest quality produce to our community."}
//               </p>
...
//               {coopProducts.slice(0, 4).map((product) => (
//                 <div
//                   key={product.id}
...
// // Enhanced Modal Component (keeping the existing one but with minor improvements)
...
//           <p className="text-red-600 mb-4 text-lg">Oops! Couldn't load the farm feed.</p>
//           <button
...
//               <p className="text-gray-500 text-lg mb-2">No fresh harvests found. Try adjusting your search.</p>
