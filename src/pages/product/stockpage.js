...
// import { useSelector } from 'react-redux';
// import { FaLeaf, FaSeedling, FaDollarSign, FaChartLine } from 'react-icons/fa';
// import ProductTable from './Allproducts';
// import InsertProductForm from './newProduct';

// const ProductCard = ({ productName, icon: Icon, quantity, description }) => (
//   <div className="bg-white shadow-lg rounded-lg p-2 sm:p-3 w-full mb-3 flex flex-col items-start">
//     <div className="flex items-center mb-1">
//       <Icon className="text-green-500 mr-2" size={20} />
//       <h2 className="text-base font-semibold text-gray-700">{productName}</h2>
//     </div>
...
//     </div>
//     <p className="text-gray-600 text-sm font-bold">${value.toFixed(2)}</p>
//   </div>
// );
...
//   const handleAddProductClick = () => setModalVisible(true);
...
//   return (
//     <div className="pt-20 px-3 flex-1 overflow-y-auto max-w-full">
...
//         {/* Financial Insights Cards */}
//         <div className="flex flex-col gap-3 mb-4">
//           <FinancialCard title="Total Stock Value" value={totalStockValue} icon={FaDollarSign} />
//           <FinancialCard title="Estimated Profit Margin" value={estimatedProfitMargin} icon={FaChartLine} />
//         </div>
...
//         {isModalVisible && (
//           <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
//             <div className="bg-white p-4 rounded-lg shadow-lg max-w-xs w-full relative">
//               <button
//                 onClick={handleCloseModal}
//                 className="absolute top-2 right-2 text-gray-500 hover:text-gray-700"
//               >
