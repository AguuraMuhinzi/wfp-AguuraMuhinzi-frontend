  ...
  provinces: [
    {
      ...
      districts: [
        ...
        { name: "Gasabo", sectors: ["Bumbogo", "Gatsata", "Gikomero", "Gisozi", "Jabana", "Jali", "Kacyiru", "Kimihurura", "Kimironko", "Kinyinya", "Ndera", "Nduba", "Remera", "Rusororo", "Rutunga"] },
    ...
    },
    {
      ...
      districts: [
        { name: "Nyaruguru", sectors: ["Busanze", "Cyahinda", "Kibeho", "Mata", "Muganza", "Munini", "Ngera", "Ngoma", "Nyabimata", "Nyagisozi", "Ruheru", "Ruramba", "Rusenge", "Kivu"] },
        ...
        { name: "Huye", sectors: ["Gishamvu", "Karama", "Kigoma", "Kinazi", "Maraba", "Mbazi", "Mukura", "Ngoma", "Ruhashya", "Rusatira", "Rwaniro", "Simbi", "Tumba", "Huye"] },
        { name: "Nyanza", sectors: ["Busasamana", "Busoro", "Cyabakamyi", "Kibirizi", "Kigoma", "Mukingo", "Muyira", "Ntyazo", "Nyagisozi", "Rwabicuma"] },
        { name: "Gisagara", sectors: ["Gikonko", "Gishubi", "Kansi", "Kigembe", "Mamba", "Muganza", "Mugombwa", "Mukindo", "Musha", "Ndora", "Nyanza", "Save"] },
