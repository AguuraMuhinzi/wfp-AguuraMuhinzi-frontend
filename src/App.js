...
// import { initNavigationGuard } from './pages/navigationGuard';
...
//                       <Route path="/aca_dashboard" element={<DashboardLayout_aca />}>a
        ...
        <Router>
            <div className="App">
                <Routes>
                    ...
                    {/* Protected Routes */}
                    <Route path="/cooperative_details" element={
                        <ProtectedRoute allowedRoles={['cooperative']}>
                            <CooperativeDetails />
                        </ProtectedRoute>
                    } />

                    <Route path="/product_display_cooperatives" element={
                        <ProtectedRoute>
                            <ProductDisplayCooperatives />
                        </ProtectedRoute>
                    } />
                    ...
                    <Route path="/aca_dashboard" element={
